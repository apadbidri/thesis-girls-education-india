...
```{r girls_OLS_models}
# English scores
model_english <- lm(engl_raw ~ has_brother + wi + sv + hhsize + mother_edu + father_edu + chldeth + typesite + birth_order + birth_order * has_brother + wi * has_brother, data = girls_df)

# Maths scores
model_maths <- lm(maths_raw ~ has_brother + wi + sv + hhsize + mother_edu + father_edu + chldeth + typesite + birth_order + birth_order * has_brother + wi * has_brother, data = girls_df)

# Language scores
model_lang <- lm(lang_raw ~ has_brother + wi + sv + hhsize + mother_edu + father_edu + chldeth + typesite + birth_order + birth_order * has_brother + wi * has_brother, data = girls_df)
